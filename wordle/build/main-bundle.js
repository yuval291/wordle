...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Game = void 0;
var Cell_1 = __webpack_require__(/*! ./Cell */ "./src/ts/Class/Cell.ts");
var words_1 = __webpack_require__(/*! ../words */ "./src/ts/words.ts");
var Game = /** @class */ (function () {
    function Game() {
        this.correctGuess = "yuval";
        this.cells = [];
        this.gameOver = false;
        this.playerWon = false;
        this.howManyRows = 0;
        this.initCells();
        var rand = Math.floor(Math.random() * words_1.WORDS.length) + 1;
        console.log(rand);
        this.correctGuess = words_1.WORDS[rand];
    ...
    Game.prototype.initCells = function () {
        ...
        for (var y = 0; y < 6; y++) {
            for (var x = 0; x < 5; x++) {
                this.cells.push(new Cell_1.Cell('empty', ''));
            }
        }
    };
    ...
    Game.prototype.addGuess = function (guess) {
        if (guess.length <= 5) {
            for (var x = 0; x < 5; x++) {
                var temp = new Cell_1.Cell('empty', '');
    ...
    // }
    Game.prototype.ifWin = function () {
        var win = true;
        var start = (this.howManyRows * 5) - 5;
        console.log(start);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.View = void 0;
var Game_1 = __webpack_require__(/*! ./Game */ "./src/ts/Class/Game.ts");
var View = /** @class */ (function () {
    function View() {
        var _this = this;
        this.guess = document.getElementById('input-guess');
        this.btn = document.getElementById('button-ok');
        this.inputGuess = [];
        this.games = new Game_1.Game();
        this.cells = [];
        for (var i = 1; i <= 6; i++) {
            for (var j = 1; j <= 5; j++) {
                this.inputGuess.push(document.getElementById("input_" + i + "_" + j));
            }
        }
        this.btn.addEventListener('click', function (ev) {
            if (!_this.games.gameOver) {
                _this.games.addGuess(_this.guess.value);
                _this.renderGame(_this.games);
